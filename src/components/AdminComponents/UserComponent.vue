...
<template>
  <div
    class="group relative col-span-3 grid grid-cols-3 p-0 md:col-span-5 md:grid-cols-5"
  >
    <div
      class="hover:bab-hover background-and-border relative col-span-3 my-1 grid grid-cols-3 p-1 text-center leading-8 hover:rounded-md md:col-span-5 md:grid-cols-5 md:p-2 md:leading-10"
    >
