...
<template>
  <div class="group relative my-1">
    <div
      class="background-and-border group-hover:bab-hover grid grid-cols-4 p-1 md:p-2 text-center leading-8 md:leading-10 group-hover:rounded-bl-none md:grid-cols-6"
    >
      <p>{{ asset.asset_tag }}</p>
      ...
      <div class="flex justify-end my-auto">
        ...
        <svg 
          ...
          viewBox="0 0 448 512"
          >
          <path fill="currentColor" stroke="currentColor" d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"/>
        </svg>
        <!-- Eyeball -->
        <svg 
          v-if="view === true"
