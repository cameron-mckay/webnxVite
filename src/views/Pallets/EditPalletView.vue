...
//   defineProps<Props>();
// 
// let palletRef = ref({} as AssetSchema);
// let palletCopy = {} as AssetSchema;
// let partsOnPallet = ref([] as AssetPart[]);
// let partsOnPalletCopy = [] as AssetSchema[];
...
//   updateAsset(http, palletRef.value, unloadedParts, correction, (data, err) => {
//     if (err) {
