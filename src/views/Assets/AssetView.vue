...
<template>
  <div class="body">
    <div
      class="relative grid grid-cols-4 rounded-lg p-2 leading-10 group-hover:rounded-bl-none group-hover:bg-zinc-400"
    >
      ...
      <p class="col-span-3" v-if="asset.chassis_type">
        {{ asset.chassis_type }}
      </p>
      <p v-if="asset.manufacturer">Manufacturer:</p>
      <p class="col-span-3" v-if="asset.manufacturer">
        {{ asset.manufacturer }}
      </p>
      ...
      <p class="col-span-3" v-if="asset.private_port">
        {{ asset.private_port }}
      </p>
